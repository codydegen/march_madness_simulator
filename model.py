...
class NodeGame(Game, NodeMixin):
  def __init__(self, team_one=Team('tbd',0,'tbd',-1,-1), team_two=Team('tbd',0,'tbd',-1,-1), parent=None, children=None):
  ...
  def simulate_game(self):
    ...
    team_one_chance = 1.0/(1.0 + 10 ** (-(self.team_one.elo-self.team_two.elo))*30.464/400)
    
    print(self.team_one.name+"'s chance of winning = %"+str(team_one_chance*100))
    if random.random() < team_one_chance:
      # team one wins
